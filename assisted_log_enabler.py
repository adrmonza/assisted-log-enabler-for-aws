...
███████ ██   ████ ██   ██ ██████  ███████ ███████ ██   ██ 
         ...
         Adrian Monza - Technical Account Manager (AWS) 
         Type -h for help.
    ''')
...
def assisted_log_enabler():
    ...
    function_parser_group.add_argument('--ava', action='store_true', help=' Turns on Amazon Verified Access Logs.')
    ...
    cleanup_parser_group.add_argument('--single_ava', action='store_true', help=' Removes Amazon Verified Access Logging Configurations created by Assisted Log Enabler for AWS.' )
    ...
    if args.mode == 'single_account':
        ...
        if args.eks:
            ...
            ALE_single_account.run_ava_logs()    
        elif args.all:
